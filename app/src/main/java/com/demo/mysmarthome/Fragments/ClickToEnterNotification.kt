 ...
 * Use the [ClickToEnterNotification.newInstance] factory method to
 * create an instance of this fragment.
 */
class ClickToEnterNotification : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_click_to_enter_notification, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment ClickToEnterNotification.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ClickToEnterNotification().apply {
